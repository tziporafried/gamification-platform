-- Migration 060: Persist first-touch affiliate (UTM) attribution on user_profiles
-- Captured on register/login when UTM params are present; never overwritten later.
...
-- Claim current-session UTMs onto the signed-in user (first-touch only).
