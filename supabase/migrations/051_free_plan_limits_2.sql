-- Migration 051: Lower the free-plan limits to 2 groups, 2 participants,
-- 2 actions (rewards unchanged at 3). Must stay in sync with FREE_PLAN_LIMITS
-- in src/lib/plans.ts. Redefines check_plan_limit() (last set in migration 050).
