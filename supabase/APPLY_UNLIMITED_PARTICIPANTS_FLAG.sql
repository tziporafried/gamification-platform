...
--
-- Source: migrations/088_unlimited_participants_flag.sql
-- Needed by: the `unlimited_participants` feature flag. Until this runs the
-- flag can be created in the admin panel and granted to a game, and nothing
-- will read it - the 70-participant cap on the independent / full / offline
-- plans keeps applying exactly as it does today.
--
-- Independent of 075/076: if those never ran, this still applies cleanly and
-- the cap simply stays on for everyone.
