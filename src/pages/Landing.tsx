...
const FAQ_ITEMS: { question: string; answer: ReactNode }[] = [
  ...
  },
  {
    ...
    answer:
      'כל משתתף מקבל כרטיס ברקוד מודפס עם המשימות שלו, מבצע אותן במהלך הפעילות וצובר נקודות. במשחק המלא סורקים את הכרטיס בעמדת הסריקה והניקוד מתעדכן אוטומטית. במשחק הידני מזינים את הניקוד מתוך המערכת, בלי סורק.',
  },
  {
    ...
    if (item.answer === 'pricing') {
      return (
        <>
          ...
          {' '}
          תמצאו את המסלולים - משחק ידני, משחק מלא ופתרון לארגונים - ואפשר גם לשלוח בקשה
          ונחזור אליכם.
        </>
      )
    }
    ...
    if (item.answer === 'withoutScanner') {
      return (
        <div className="space-y-2">
          <p>
            כן. במשחק הידני מעדכנים את הניקוד מתוך המערכת במקום להשתמש בסורק.
